...
require_once $conf->root_path.'/app/kalk/KalkForm.class.php';
require_once $conf->root_path.'/app/kalk/KalkRata.class.php';
	...
	public function process()
{
	...
	public function generateView(){
		...
		$smarty->display($conf->root_path.'/app/kalk/kalkredyt.html');
	}
}
